...
export function Step3({ selectedVideo, onSelect }: Step3Props) {
  const videoReviews = [
    ...
    },
    {
      ...
      rating: 4.6,
      description:
        "✨レシピを選択🥳 :ピンク1本 乾燥肌のうちの子にピッタリの優しいローション。肌がもちもちで、べたつかずサラっと伸びるのにしっかり潤いキープ！☺️💦 香りも強すぎず癒されます🌱。お風呂上がりやおむつ替えの後の乾燥が全く気にならなくなりました！赤ちゃんの肌トラブルに悩む方に超おすすめです✨🙆",
    },
    {
      id: "video3",
      author: "Jerry",
    ...
    },
    {
      ...
      rating: 4.5,
      description:
        "✨一日中続く素敵な香り&しっとり保湿✨ 赤ちゃんの乾燥しがちな肌も、朝から夜まで潤い続きます！使いやすくてすぐに吸収され、ベタつきなし👼毎日のお手入れに欠かせません！敏感肌の子どもでも赤くならず、しっとりツルツルに。香りも控えめで親子一緒に癒やされています💖オススメ度MAX‼️",
    },
  ];
